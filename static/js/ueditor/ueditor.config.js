...
(function () {
	...
	window.UEDITOR_HOME_URL = projectName+'/resources/ueditor1_3_6-utf8-jsp/';
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,imagePath: window.document.location.protocol+"//"+window.document.location.host+projectName+"/"  
...
//      ,savePath: [ 'upload' ]    //图片保存在服务器端的目录， 默认为空， 此时在上传图片时会向服务器请求保存图片的目录列表，
        ...
        ,scrawlPath:projectName+"/uploadImage"                           //图片修正地址，同imagePath

        //附件上传配置区
        ,fileUrl:URL+"jsp/fileUp.jsp"               //附件上传提交地址
        ,filePath:projectName+"/uploadImage"                    //附件修正地址，同imagePath
        //,fileFieldName:"upfile"                    //附件提交的表单名，若此处修改，需要在后台对应文件修改对应参数

        //远程抓取配置区
        ,catchRemoteImageEnable:false               //是否开启远程图片抓取,默认开启
        ,catcherUrl:URL +"jsp/getRemoteImage.jsp"   //处理远程图片抓取的地址
        ,catcherPath:projectName+"/uploadImage"                   //图片修正地址，同imagePath
        ...
        ,videoPath:projectName+"/uploadImage"                    //附件修正地址，同imagePath
