    <%@ page language="java" contentType="text/html; charset=utf-8"
        ...
        <%@ page import="com.bravowhale.base.file.Uploader" %>
        <%@ page import="java.io.File" %>
        <%@ page import="java.util.Map" %>
        <%@page import="org.springframework.web.context.support.WebApplicationContextUtils"%>  
		<%@page import="org.springframework.context.ApplicationContext"%>  
		<%@page import="com.bravowhale.business.sys.config.FileRepository"%> 
...
FileRepository fileRepository = (FileRepository)ctx.getBean("fileRepository");

String repositoryPath = fileRepository.getLocalPath();
