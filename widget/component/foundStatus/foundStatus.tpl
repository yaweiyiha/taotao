		...
		<div v-if="collectStatus" class="col-md-6"  style="display: block;">
		    <div class="form-group" style="padding-right:15px">
		        <div class="input-group">
		            ...
		            <single-date  :disable="disable" :key="startDateInterest" placeholder="请输入固定日期"></single-date>
				</div>
		    </div>
		</div>
	</div>
	...
	<div class="row">
		...
		<div v-if="proCollect" class="form-group input-group"> 
		     <div class="input-group-addon input-title" style="min-width:120px">产品状态     
		      ...
		      <input type="radio" :disabled="disable" class="radio-input"  name="collect"  value="10" v-model="collect"> 预售
		      <input type="radio" :disabled="disable" class="radio-input" name="collect"  checked="checked" value="20" v-model="collect"> 在售
		      <input type="radio" :disabled="disable" class="radio-input" name="collect" value="30"> 售罄
  		</div>
  		...
  		<div v-if="collectStatus" class="form-group input-group"> 
		     <div class="input-group-addon input-title" style="min-width:120px">产品状态     
		      ...
		      <input type="radio" :disabled="disable" class="radio-input" name="founed"  checked="checked" value="20"  > 执行中
				    ...
				    <span>(</span>
		      		<input type="radio" :disabled="disable" class="radio-input" name="doing" value="30" checked="checked"> 封闭状态
		      		<input type="radio" :disabled="disable" class="radio-input" name="doing" value="30"> 开放状态
  		...
  		<div v-if="failStatus" class="form-group input-group"> 
		     <div class="input-group-addon input-title" style="min-width:120px">产品状态     
		      ...
		      <input type="radio" :disabled="disable" class="radio-input"  name="founed"  value="10" checked="checked"> 募集失败
  		</div>  
