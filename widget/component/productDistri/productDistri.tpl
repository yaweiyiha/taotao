<div class="styleguide admin-widget-productDistri">   
		...
		<div class="col-md-6 input-wrapper">                          
			<div class="form-group input-group">                  
				...
				<select class="form-control" data-key="name" v-model="productselect">
		...
		<div class="col-md-6 input-wrapper">                          
			<div class="form-group input-group">                  
				...
				<select class="form-control" data-key="distributor">       					<	 <template v-for="pro in products">
						<option value="{{pro.agentId}}">{{pro.agentName}}</option>
					</template>                                                       	                                              
			</select>              
		</div>                                                                                          
</div>
