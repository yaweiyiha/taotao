<div class="styleguide admin-widget-productDistri">   
		...
		<div class="col-md-6 input-wrapper">                          
			<div class="form-group input-group">                  
				...
				<select class="custom-input bln" is-num="1" data-key="productId" v-model="productselect">
		...
		<div class="col-md-6 input-wrapper">                          
			<div class="form-group input-group">                  
				...
				<select class="custom-input bln" data-key="agentId" is-num="1">       					<template v-for="distri in distributors">
