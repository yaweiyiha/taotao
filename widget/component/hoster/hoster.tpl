<div class="styleguide admin-widget-hoster col-md-6 input-wrapper rt">
  <div class="form-group input-group w100">
      ...
      <input v-if="custodiantype!=='10'" type="text" class="input-control" data-key="custodianParty" style="width:50%;float:right" placeholder = "{{placeholder}}" v-model="custodian" :disabled="disable">
  </div>
</div>