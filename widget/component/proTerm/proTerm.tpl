<div class="styleguide admin-widget-proTerm">
	<div class="col-md-6">
		    ...
		    <div class="col-xs-8 col-xs-left prn ">
		        <div class="form-group">
		             <div class="input-group">
		                <div class="input-group-addon">产品期限
		                	<span  class="text-strong-red">*</span>
		                </div>
		                <input class="input-control brn" data-key="maturities" placeholder="请输入产品期限" :disabled="disable" data-number="number" data-des="产品期限">
		            </div>
		        </div>
		    </div>
		    <div class="col-xs-4 col-xs-right pln ">
		        <div class="form-group">
		            <select class="input-control valid bld" data-key="unitFkMaturities" v-model="unitMaturities" :disabled="disable">
		...
		<template v-if="unitMaturities === '-3'">
				...
				<div class="col-xs-8 col-xs-left prn">
				    <div class="form-group">
				        <div class="input-group">
		                    ...
		                    <input :disabled="disable" class="input-control brn" data-key="startingInvest" placeholder="请输入起购期限">
				        </div>
				    </div>
				</div>
			...
			<div class="col-xs-4 col-xs-right pln">
				<div class="form-group">
				    <select class="input-control valid bld" data-key="unitFkStartingMaturities" :disabled="disable" is-num="true">
