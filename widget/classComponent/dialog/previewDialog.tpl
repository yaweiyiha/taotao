<div class="dialog-cover">
	...
	<div class="ui-dialog ui-widget ui-widget-content admin-widget-dialog" tabindex="-1" role="dialog" aria-describedby="departmentSelectWin" aria-labelledby="ui-id-1">
		...
		<div v-if="type === 'preview'" class="modal-body">{{info}}</div>
