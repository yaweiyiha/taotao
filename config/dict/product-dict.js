export default {
	...
	'unitFkOfMaxInvestmentPrice':  { key :'unitFkOfMaxInvestmentPrice' ,name : '', wrapperClass : 'col-md-2 pln' ,   type : 'select', bln: true, 
 	...
 	'paymentTransferCardNumber' :{ key :'paymentTransferCardNumber' ,name : '卡号', textStyle: {minWidth: '130px'}, wrapperClass : 'col-md-6' ,   type : 'input',placeholder : '请输入卡号',validate: {isrequire : true, isNumber : true}},
