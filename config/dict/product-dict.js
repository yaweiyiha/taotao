export default {
	...
	'saleSize' 		:  { key :'offeringSize' , reg: '^\d+\.?\d*$', regError: '需要为数字', name : '可销售份额', wrapperClass : 'col-md-4 prn',brd : true, type : 'input',placeholder : '请输入可销售份额',isrequire : true}, 				 
 	'proTerm' 		:  { key :'maturities' ,name : '产品期限', wrapperClass : 'col-md-4 prn' ,   brd : true,  type : 'input',placeholder : '请输入产品期限' , options : ['无'],isrequire : true},
 	...
 	'purchaseAmount':  { key :'startingPrice', reg: '^\d+\.?\d*$', regError: '需要为数字',  name : '起购金额', wrapperClass : 'col-md-4 prn',brd : true, type : 'input',placeholder : '请输入起购金额',isrequire : true},
 	'increasingAmount':{ key :'increasement' , reg: '^\d+\.?\d*$', regError: '需要为数字',  name : '递增金额', wrapperClass : 'col-md-4 prn',brd : true, type : 'input',placeholder : '请输入递增金额',isrequire : true},
	...
	'investManager' : { key :'investManager' ,name : '投资经理', wrapperClass : 'col-md-6' ,   type : 'input',placeholder : '请输入投资经理'},
 	...
 	'proLocation'   : { key :'locationFk' ,name : '项目所在地', wrapperClass : 'col-md-6' ,   type : 'area', placeholder : '请输入投资经理', isrequire: true, placeholder: '请添加项目所在地'},
