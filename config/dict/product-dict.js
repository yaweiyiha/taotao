export default {
	...
	'executeState' 	:  { key :'executeState' ,name : '执行中', wrapperClass : 'col-md-6' ,  type : 'radios',radios : [{'name': '已结束','checked' : 'checked'},{'name' : '执行中'} ],validate: {isrequire : true}},
	...
	'openDay'		: { key :'openDayDesc' ,name : '开放日', wrapperClass : 'col-md-6' ,   type : 'input', placeholder : "请输入开放日"},
	...
	'endPurchase'	: { key :'endDatePurchase' ,name : '截止日', wrapperClass : 'col-md-6' ,   type : 'singledate', placeholder : "请选择截止日",validate: {isrequire : true}},
 	...
 	'personnelPolicy' : { key :'orderNumber' ,name : '人员策略', wrapperClass : 'col-md-6' ,   type : 'radios',radios : [{'name': '员工' },{'name' : '直销员','checked' : 'checked' } ] },
 	...
 	'employeePolicy'  : { key :'orderNumber' ,name : '员工策略', wrapperClass : 'col-md-6 none' ,   type : 'select', 
					   options : ['全部']},
 	'comComputePolicy' : { key :'orderNumber' ,name : '佣金计算规则', wrapperClass : 'col-md-6' ,   type : 'radios',radios : [{'name': '直接佣金','checked' : 'checked'},{'name' : '月度业绩' } ] },
	...
	'investManager' : { key :'investManager' ,name : '投资经理', wrapperClass : 'col-md-6' ,   type : 'input',placeholder : '请输入投资经理'},
 	'isRiskRating'  : { key :'isRiskRating' ,name : '是否启用风险等级', wrapperClass : 'col-md-4' ,   type : 'radios',radios : [{'name': '启用' ,'checked' : 'checked', value: '1'  },{'name' : '关闭', value: '2'} ] },
 	'proLocation'   : { key :'locationFk' ,name : '项目所在地', wrapperClass : 'col-md-6' ,   type : 'area', placeholder: '请添加项目所在地', validate: {isrequire : true}},
	...
	'unitFkOfMaxInvestmentPrice':  { key :'unitFkOfMaxInvestmentPrice' ,name : '', wrapperClass : 'col-md-2 pln' ,   type : 'select', bln: true, 
						options : ['元','万元','亿元'],value : [1100,1200,1300] , isNum : 1,validate: {isrequire : false}},
 	'showStatus'	 : { key :'available' ,name : '展示状态', wrapperClass : 'col-md-6' ,   type : 'radios',radios : [{'name': '上架','checked' : 'checked' ,'value' : '10'},{'name' : '下架','value' : '20' }  ] },
 	'paymentTransferCardOwner' :{ key :'paymentTransferCardOwner' ,name : '持卡人', wrapperClass : 'col-md-6' ,   type : 'input',placeholder : '请输入持卡人',validate: {isrequire : true}},
 	'paymentTransferBankId' :{ key :'paymentTransferBankId' ,name : '银行', wrapperClass : 'col-md-6' ,   type : 'select',placeholder : '请输入银行',validate: {isrequire : true}},
 	'paymentTransferCardNumber' :{ key :'paymentTransferCardNumber' ,name : '卡号', wrapperClass : 'col-md-6' ,   type : 'input',placeholder : '请输入卡号',validate: {isrequire : true, isNumber : true}},
 	'paymentTransferBranch' :{ key :'paymentTransferBranch' ,name : '支行', wrapperClass : 'col-md-6' ,   type : 'input',placeholder : '请输入支行'},
 	'paymentTransferCardNumberAgain' :{ key :'paymentTransferCardNumberAgain' ,name : '再次输入卡号', wrapperClass : 'col-md-6' ,   type : 'input',placeholder : '请再次输入卡号',validate: {isrequire : true,isNumber : true}},
 	...
 	'prostatus' : { key :'salesStatusFk' ,name : '产品状态', wrapperClass : 'col-md-6' ,  type : 'radios',radios : [{'name': '预售',value: '20' },{'name' : '在售',value: '10' },{'name' : '售罄',value: '30' } ]},
